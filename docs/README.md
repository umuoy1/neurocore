...
| 10 | [`project-ledger.json`](11_2026-04-27_personal-agent-competitive-spec/project-ledger.json) | 机器可读任务 ledger——`pa:plan-check / pa:next-task / pa:start / pa:task-check / pa:accept` 的单一真相源 |
